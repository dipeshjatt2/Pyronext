...
.. raw:: html
    ...
    <div style="float: right; margin-bottom: 10px">
        <a class="github-button"
           href="https://github.com/dipeshjatt2/Pyronext"
           data-color-scheme="no-preference: light; light: light; dark: dark;"
           data-icon="octicon-star" data-size="large" data-show-count="true"
           aria-label="Star dipeshjatt2/Pyronext on GitHub">Star</a>

        <a class="github-button"
           href="https://github.com/dipeshjatt2/Pyronext/fork"
           data-color-scheme="no-preference: light; light: light; dark: dark;"
           data-icon="octicon-repo-forked" data-size="large"
           data-show-count="true" aria-label="Fork dipeshjatt2/Pyronext on GitHub">Fork</a>
    </div>
